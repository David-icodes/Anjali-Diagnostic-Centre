...
// Departments removed per request — keep backend compatibility but hide from UI
        ...
        <PageTransition>
          <section className="relative flex min-h-[28vh] items-center overflow-hidden bg-gradient-to-br from-[#0F766E] via-[#14B8A6] to-[#2DD4BF]">
            ...
            <div className="relative mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
                ...
                <p className="mt-4 max-w-2xl text-base text-white/80 sm:text-lg">Search and book one or more laboratory tests from the booking page.</p>
              </div>
            </div>
          </section>
          ...
          <section className="py-10 sm:py-12 lg:py-14">
            <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
              ...
              {/* Departments UI removed — no chips shown */}
