                    ...
                    <motion.div key="step2" initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-3">
                            {['Male', 'Female', 'Other'].map((g) => (
                              <label key={g} className="flex flex-1 min-w-[100px] items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 cursor-pointer hover:border-[#1BAE9A]/30 transition-all has-[:checked]:border-[#1BAE9A] has-[:checked]:bg-[#1BAE9A]/5">
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-3">
                            {['Yes', 'No'].map((opt) => (
                              <label key={opt} className="flex flex-1 min-w-[80px] items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-gray-200 cursor-pointer hover:border-[#1BAE9A]/30 transition-all has-[:checked]:border-[#1BAE9A] has-[:checked]:bg-[#1BAE9A]/5">
